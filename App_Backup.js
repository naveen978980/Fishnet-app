...
export default function App() {
  ...
  const [showFullScreenMap, setShowFullScreenMap] = useState(false); // Full screen map state
      ...
      {showFullScreenMap && (
        <View style={styles.fullScreenMapContainer}>
          ...
          <View style={styles.fullScreenMapLegend}>
            <Text style={styles.fullScreenMapLegendText}>📍 7 Fishing Hotspots Near Chennai • Tap to explore</Text>
          </View>
        </View>
      )}
    </View>
